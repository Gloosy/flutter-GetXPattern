...
class RouteHelper {
  ...
  static String getFoodDetail (int? slideId,String? screen) =>'$foodDetail?slide=$slideId&page=$screen';
  static String getRecommendedFoodDetail (int? id)=> '$recommendedFoodDetail?id=$id';
  ...
  static List<GetPage> routes =[
    GetPage(name: splashScreen, page: () =>SplashScreen() ,transition: Transition.downToUp ),
    GetPage(name: initial, page: () =>HomeScreen() ,transition: Transition.downToUp ),
    GetPage(name: foodDetail, page: (){
      var slideId = Get.parameters['slide'];
      var screen = Get.parameters['page'];
      print('Route :$screen');
      return FoodDetailScreen(slideId: int.parse(slideId!),screen : screen!);
    },
