...
import 'package:food_delivery_app/view/location_screen/location_screen.dart';
import 'package:persistent_bottom_nav_bar/persistent_tab_view.dart';

import '../../utils/colors.dart';

import '../cart_screen/cart_history_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Widget> _buildScreens() {
    return [MainFoodScreen(), LocationScreen(), CartHistoryScreen(), AccountScreen()];
  }
